...
library MerklePatriciaProofVerifier {
    ...
    uint256 constant emptyMPTRootError = 64;
    uint256 constant rootHashNotMatch = 65;
    uint256 constant proofNodeNotMatch = 66;
    uint256 constant toListError = 67;
    uint256 constant divergentNodeError = 68;
    uint256 constant extensionNodelastlevel = 69;
    uint256 constant leafExtensionNodeNotLast = 70;
    uint256 constant nibbleToLarge = 71;
    uint256 constant valueNotLast = 72;
    uint256 constant merklePatriciaCompactDecodeError = 73;
    uint256 constant decodeNibblesError = 74;
    uint256 constant leafFullNodeNotLast = 75;
    uint256 constant toBytesError = 76;
    ...
    function extractProofValue(
        ...
        if (stack.length == 0) {
            ...
            if(rootHash != 0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421){
                revert();
            }
            return new bytes(0);
        }
